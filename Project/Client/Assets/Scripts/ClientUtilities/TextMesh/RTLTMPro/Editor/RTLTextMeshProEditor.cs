    ...
    public class RTLTextMeshProEditor : TMP_UiEditorPanel
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (fixNumberStyle == null)
            {
                ...
                {
                    fontSize = 12,
                    normal = { textColor = TMP_UIStyleManager.label.normal.textColor },
                    richText = true
                };
            }
            ...
            GUI.Label(rect, "<b>RTL TEXT INPUT BOX</b>" + (foldout ? UIStateLabel[1] : UIStateLabel[0]), TMP_UIStyleManager.label);
            ...
            {
                EditorGUI.BeginChangeCheck();
                originalTextProp.stringValue = EditorGUILayout.TextArea(originalTextProp.stringValue, TMP_UIStyleManager.wrappingTextArea, GUILayout.Height(125), GUILayout.ExpandWidth(true));
