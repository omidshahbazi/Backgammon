...
namespace Networking.Server.Data
{
	static class DatabaseGenerator
	{
		...
		private static Table UsersTable = new Table("users", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("device_id", DataType.VarChar), new Column("username", DataType.NVarChar), new Column("avatar", DataType.Int), new Column("status", DataType.Int), new Column("split_test_group_id", DataType.Int));
