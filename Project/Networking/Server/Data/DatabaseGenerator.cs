...
namespace Networking.Server.Data
{
	static class DatabaseGenerator
	{
		...
		private static Table UsersTable = new Table("users", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("device_id", DataType.VarChar), new Column("username", DataType.NVarChar), new Column("avatar", DataType.Int), new Column("status", DataType.Int), new Column("split_test_group_id", DataType.Int), new Column("register_time", DataType.DateTime));
		...
		private static Table UsersLogin = new Table("users_login", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("user_id", DataType.Int), new Column("market", DataType.Int), new Column("version", DataType.Int), new Column("ip", DataType.VarChar), new Column("rtt", DataType.Int), new Column("result", DataType.Int), new Column("start_time", DataType.DateTime), new Column("end_time", DataType.DateTime));
