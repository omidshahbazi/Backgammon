...
namespace Networking.Server.Data
{
	static class DatabaseGenerator
	{
		...
		private static Table UsersGameTable = new Table("users_game", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("type", DataType.Int), new Column("table_id", DataType.Int), new Column("table_id", DataType.Int), new Column("white_user_id", DataType.Int), new Column("black_user_id", DataType.Int), new Column("bot_user_info", new DataType("VARCHAR", 500)), new Column("winner_user_id", DataType.Int), new Column("finish_reason", DataType.Int), new Column("start_time", DataType.DateTime), new Column("end_time", DataType.DateTime), new Column("version", DataType.Int), new Column("replay_data", DataType.LongBlob));
		...
		private static Table Users_purchase = new Table("users_purchase", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("user_id", DataType.Int), new Column("market_id", DataType.Int), new Column("pack_id", DataType.Int), new Column("sku", DataType.VarChar), new Column("price", DataType.Int), new Column("pack", DataType.Text), new Column("token", DataType.VarChar), new Column("is_valid", DataType.Int), new Column("occurs_time", DataType.DateTime), new Column("instant_level", DataType.Int), new Column("instant_coin", DataType.Int));
		...
		private static Table UsersDice = new Table("users_dice", Collates.UTF8, Engines.InnoDB, new Column("id", DataType.Int, Flags.PrimaryKey | Flags.AutoIncrement), new Column("user_id", DataType.Int), new Column("dice_id", DataType.Int));
