...
public class GameManagerTests
{
    ...
    public void D_AreFieldValid()
    {
        ...
        Assert.IsTrue(GM.FieldsOrder.Length == 24, "FieldsOrder list has to have exactly 24 elements");
        if (GM.FieldsOrder != null)
        {
            for(int iField = 0; iField < GM.FieldsOrder.Length; ++iField)
            {
    ...
    public void E_AreDicesValid()
    {
        ...
        Assert.IsTrue(GM.Dices.Length == 2, "Dices list has to have exactly 2 elements");
        if (GM.Dices != null)
        {
            for (int iDice = 0; iDice < GM.Dices.Length; ++iDice)
            {
