...
public class PossibleMoves
{
    ...
    protected DiceController[] Dices = null;

    public PossibleMoves(GameManager InGameManager, PawnsContainer InContainer, DiceController[] InDices, bool bSingleDiceMoves = false)
    {
        if(InGameManager)
        {
            Dices = InDices;
