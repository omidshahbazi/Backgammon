...
public class GameManager : MonoBehaviour
{
    ...
    public FieldController[] FieldsOrder = new FieldController[26];
    public DiceController[] Dices = new DiceController[2];
    ...
    void Start()
    {
        ...
        for(int i = 0; i< FieldsOrder.Length; ++i)
            FieldsOrder[i].OnClicked += Field_OnClicked;
    ...
    public DiceController[] GetDices()
    {
        return Dices;
    }
    ...
    public int GetIndexOf(PawnsContainer InContainer)
    {
        if (InContainer is BandController)
            ...
            return Array.IndexOf(FieldsOrder, InContainer as FieldController);
    }
    ...
    {
        return InIndex >= 0 && InIndex < FieldsOrder.Length;
    }
