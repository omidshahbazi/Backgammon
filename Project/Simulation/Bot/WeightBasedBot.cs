...
namespace Simulation.Bot
{
	public static class WeightBasedBot
	{
		...
		public static readonly Configuration EXPERT_CONFIGURATION = new Configuration(0.2F, 4.0F, 2.0F, 0.700000048F);
		public static readonly Configuration HARD_CONFIGURATION = new Configuration(0.4F, 2.0F, 1.5F, 0.700000048F);
		public static readonly Configuration MEDIUM_CONFIGURATION = new Configuration(0.6F, 1.2F, 0.9F, 0.700000048F);
		public static readonly Configuration EASY_CONFIGURATION = new Configuration(0.8F, 0.5F, 0.1F, 0.700000048F);
